// Sweep-stage ruling: a clear clicked while the first-connect backfill is out is honoured. The
// backfill's rows were all captured before the click, so a cleared pane, the CAN table and
