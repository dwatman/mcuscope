// Fix-diff round 2, settings.js: the dialog now opens before /config answers (SPEC 9.1), so
// what it leaves live while loading is new ground. FD2-1: the fields the daemon owns are held
