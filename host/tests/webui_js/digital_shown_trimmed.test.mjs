// digital.js: a lane window past a trimmed id index goes by time on that side (H1), host-base
// lanes go by id, a lane stream the cap refused adds no id (L4), and the disabled shown
