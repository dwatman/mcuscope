// Owner ruling E-3/E-9 (2026-09-15 pre-release): a token-less export is preflighted before the
// navigation, so a daemon refusal is shown and the dialog stays open; a session .db export
// checks the session still exists instead, and neither is ever read into the tab.
