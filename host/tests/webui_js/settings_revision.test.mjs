// settings.js, owner rulings E-8, A-5 and E-9: every config save sends the revision
// the dialog loaded and adopts the one each save answers, a file changed since is
