// statusbar.js: the Attach dialog opens from the click in a loading state and fills when the
// daemon answers, so a slow daemon cannot move focus seconds after the click.
