// Fix-diff round 2, api.js runBackfill: what a clear clicked while the backfill is out may and
// may not take with it (PD-1, PD-2), and the generation tokens a capture reset moves (PD-6).
