// exportdlg.js: overlapping session fills write once, an Export pressed across a `reset range`
// waits for the fill that owns the select, and the portless plot key sends no port.
