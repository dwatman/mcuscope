"""Pre-release round, daemon core: `/plot/export` refusals and the decoded wide header
(A-3, A-8, A-11, B-16, F-28, F-29).
...
from tests.test_plot_export_decode import DEF, client, csv_rows, export, feed, sample
