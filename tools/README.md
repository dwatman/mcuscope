...
- `webui_smoke.py` - manual smoke harness for the web UI (SPEC 9.1).
  - Brings up the simulator and daemon in-process, auto-verifies the API-observable acceptance criteria, then serves `http://127.0.0.1:8765/ui/` and stays running so you can eyeball each panel in a browser.
